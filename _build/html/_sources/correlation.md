...
```{figure} https://dereksonderegger.github.io/570L/A_Sufficient_Introduction_to_R_files/figure-html/unnamed-chunk-190-1.png
:height: 250px
```
...
```{figure} https://miro.medium.com/v2/resize:fit:720/format:webp/1*M2187QiB0o0I6r0JfM0JBg.jpeg
```
